...
class MainActivity : AppCompatActivity() {
    ...
    private fun init () {
        ...
        mainController = MainController(this, mainModel)
    ...
    fun showRules(title: String, text: String){
    ...
    fun gameOver(title: String, text: String) {
        val builder = AlertDialog.Builder(this)
        builder.setTitle(title)
        builder.setMessage(text)
        builder.setPositiveButton(R.string.OK) { _, _ -> mainController.resetGame() }
        builder.setCancelable(false)
        builder.show()
    }
    fun resetView(text: String) {
